...
type CreateShippingResponse struct {
	...
	DeliveryDays  int64                  `protobuf:"varint,2,opt,name=delivery_days,json=deliveryDays,proto3" json:"delivery_days,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateShippingResponse) GetDeliveryDays() int64 {
	if x != nil {
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\x05items\x18\x02 \x03(\v2\x16.shipping.ShippingItemR\x05items\"^\n" +
	"\x16CreateShippingResponse\x12\x1f\n" +
	"\vshipping_id\x18\x01 \x01(\x03R\n" +
	"shippingId\x12#\n" +
	"\rdelivery_days\x18\x02 \x01(\x03R\fdeliveryDays2Y\n" +
	"\bShipping\x12M\n" +
	"\x06Create\x12\x1f.shipping.CreateShippingRequest\x1a .shipping.CreateShippingResponse\"\x00B<Z:github.com/Luiz-Gomess/microservices-proto/golang/shippingb\x06proto3"
