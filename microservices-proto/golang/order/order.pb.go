...
func (x *CreateOrderReponse) GetOrderId() int32 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
const file_order_order_proto_rawDesc = "" +
	...
	"\x05Order\x124\n" +
	"\x06Create\x12\x13.CreateOrderRequest\x1a\x13.CreateOrderReponse\"\x00B5Z3github/Luiz-Gomess/microservices-proto/golang/orderb\x06proto3"
...
var file_order_order_proto_goTypes = []any{
	...
	(*CreateOrderReponse)(nil), // 2: CreateOrderReponse
}
var file_order_order_proto_depIdxs = []int32{
	...
	2, // 2: Order.Create:output_type -> CreateOrderReponse
